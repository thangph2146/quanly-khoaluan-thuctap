...
export function AcademicYearDetail({ academicYear }: AcademicYearDetailProps) {
  ...
  const calculateDuration = (startDate: string, endDate: string) => {
    ...
    return `${diffDays} ngày (≈ ${diffMonths} tháng)`
  }
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm">{calculateDuration(academicYear.startDate, academicYear.endDate)}</p>
          </div>
        </CardContent>
      </Card>
